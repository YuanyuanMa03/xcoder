...
export const DESCRIPTION = 'Get or set xcoder configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set xcoder configuration settings.

  View or change xcoder settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
